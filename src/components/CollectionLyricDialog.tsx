...
type CollectionLyricButtonProps = {
  lyricId: number;
};

export default function CollectionLyricButton({
  lyricId,
}: Readonly<CollectionLyricButtonProps>) {
  ...
  const addLyricToCollection = async (collectionId: string) => {
    if (!authToken) return;
    setLoading(true);
                        ...
                        >
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              if (collection.isInCollection) {
                                ...
                                addLyricToCollection(collection.id);
                              }
                            }}
                          >
                          ...
                          {editingId === Number(collection.id) ? (
                            ...
                            <div className="group flex w-full items-center justify-between">
                              {/* <button
                                className="flex flex-1 cursor-pointer items-center justify-between rounded-md px-2 py-1"
                                onClick={(e) => {
                                  e.stopPropagation();
                                  e.preventDefault();
                                  if (loading) return;
