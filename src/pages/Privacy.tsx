const Privacy = () => {
  return (
    <div className="container">
      <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3  bg-light py-5">
        <div className="py-5 text-center">
          <h1 className="display-4">Privacy Policy</h1>
          <p className="lead">We ensure's, your Data is Secure</p>
        </div>
        <p className="text-[#666666] text-end fs-6 fw-light">
      ...
      <div className="container p-5 justify-content">
        ...
        <div className="p-1">
          ...
          <p>
            ...
            the app
            <ul>
              <li className="text-decoration-underline">Google Play Services</li>
            </ul>
          </p>
        </div>
