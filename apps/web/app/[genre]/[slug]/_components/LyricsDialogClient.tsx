    ...
    <>
      <div className="sticky bottom-10 z-10 mb-4 flex w-full justify-center">
        <button
          ...
          className={`btn-secondary flex max-w-65 cursor-pointer items-center justify-center gap-2 rounded-sm px-3 py-1.5 text-base font-medium text-white sm:px-4 sm:py-2 ${!isInitialized ? "cursor-not-allowed" : ""}`}
        >
